...
import { AlertTriangle, Calendar, Check, Mail, Sparkles, TrendingUp, User } from "lucide-react"
import { roleConfig } from "./accountConfig"

export default function ProfilePage() {
  const { user, role, accountId } = useAuth()
  ...
  useEffect(() => {
    const fetchStats = async () => {
      if (!userId || accountId === undefined) return
