      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">Ingresa tu correo y te enviaremos un enlace para restablecer tu contraseña</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {error && (
                <div className="flex items-start gap-3 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm text-red-300 font-medium">No pudimos enviar el correo</p>
              ...
              {success && (
                <div className="flex items-start gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm text-green-300 font-medium">Correo enviado</p>
